            ...
            <nav className="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
                <div className="container">
                    ...
                    <ul className="navbar-nav text-uppercase ml-auto">
                        ...
                        <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/user/post">CÔNG THỨC</a>
                        </li>
                        <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/user/member">THÀNH VIÊN</a>
                        </li>
                        <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/user/blog">BLOG</a>
                        </li>
                        <li className="nav-item">
